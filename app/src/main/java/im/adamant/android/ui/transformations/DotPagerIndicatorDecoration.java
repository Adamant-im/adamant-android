...
public class DotPagerIndicatorDecoration extends RecyclerView.ItemDecoration {
    ...
    public void onDrawOver(Canvas c, RecyclerView parent, RecyclerView.State state) {
        ...
        } else if (currentPosition > activePosition) {
        ...
        if (currentDirection == Direction.LEFT) {
            ...
            drawHighlightsLefts(c, indicatorStartX, indicatorPosY, activePosition, progress, itemCount);
        } else {
            float progress = mInterpolator.getInterpolation(left * -1 / (float) width);
            drawHighlightsRights(c, indicatorStartX, indicatorPosY, activePosition, progress, itemCount);
        }
    }
    ...
    private void drawHighlightsLefts(Canvas c, float indicatorStartX, float indicatorPosY,
    ...
    private void drawHighlightsRights(Canvas c, float indicatorStartX, float indicatorPosY,
                                     int highlightPosition, float progress, int itemCount) {
        mPaint.setColor(colorActive);
