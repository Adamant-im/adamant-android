...
public abstract class MainScreenModule {
    ...
    public static FragmentsAdapter provideFragmentAdapter(MainScreen mainScreen){
        List<Class> fragments = Arrays.asList(new Class[]{WalletScreen.class, ChatsScreen.class, SettingsScreen.class});
        return new FragmentsAdapter(mainScreen.getSupportFragmentManager(), fragments);
    }
